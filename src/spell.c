...
static int can_be_compound(trystate_T *sp, slang_T *slang, char_u *
                                   compflags,
                                   int flag);
...
static slang_T *spell_load_file(char_u *fname, char_u *lang, slang_T *
                                        old_lp,
                                        int silent);
...
static void spell_find_suggest(char_u *badptr, int badlen, suginfo_T *
...
static void add_suggestion(suginfo_T *su, garray_T *gap, char_u *
...
static void get_compflags(afffile_T *affile, char_u *afflist,
                                  char_u *store_afflist);
static int store_aff_word(spellinfo_T *spin, char_u *word, char_u *
...
static int store_word(spellinfo_T *spin, char_u *word, int flags,
                              ...
                              int need_affix);
static int tree_add_word(spellinfo_T *spin, char_u *word, wordnode_T *
